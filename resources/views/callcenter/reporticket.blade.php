    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('menu.tickets')}}</span>
            </div>
        </div>
                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">الطلبات</a></li>
                                           {{--  <li><a href="#tab5" class="nav-link" data-toggle="tab">تتبع الطلب</a></li>
