                            ...
                            <table id="example" class="table key-buttons text-md-nowrap" style="font-size: 16px">
                                <thead>
                                    <tr>
                                        ...
                                        {{-- <th class="border-bottom-0">عدد مرات التقييم</th> --}}
                                        <th class="border-bottom-0">ممتاز</th>
                                        <th class="border-bottom-0">جيد</th>
                                        <th class="border-bottom-0">راضي</th>
                                        <th class="border-bottom-0">سيئ</th>
                                        <th class="border-bottom-0">سيئ جداً</th>
