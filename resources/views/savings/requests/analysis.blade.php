    ...
    <div class="row">
        ...
        @if (count($found) != 0)
                @foreach ($found as $item)    
                    @if ($item->endServiceEmp)
                        <div class="col-lg-6 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4>صاحب الطلب :  {{$empName}}</h4>
                                    <h6> الرقم الوظيفي: {{ $empid}}</h6>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="salary" name="salary" value="{{ $typeOrder }}" readonly>
                                        </div>
                                        <div class="col">
                                            <label for="purchasingValue" class="control-label">القيمة الشرائية</label>
                                            <input type="text" class="form-control" id="purchasingValue" name="purchasingValue" value="{{ number_format($purchasingValue,2) }}" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="salary" class="control-label">الراتب</label>
                                            <input type="text" class="form-control" id="salary" name="salary" value="{{ $orderSalary }}" readonly>
                                        </div>
                                        <div class="col">
                                            <label for="endService" class="control-label">قسط الإشتراك</label>
                                            <input type="text" class="form-control" id="endService" name="endService" value="{{ $deductionsBox }}" readonly>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="balanceboxEmp" name="balanceboxEmp" onfocusout="calc()" value="{{$item->balanceboxEmp}}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <label for="empid" class="control-label">إجمالي الضمانات</label>
                                        <input type="text" class="form-control" id="totalGuaranteesEmp" name="totalGuaranteesEmp"  readonly>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="debtFurnitureEmp" name="debtFurnitureEmp" value="{{$item->debtFurnitureEmp}}" onfocusout="calc()">
                                        </div>
                                        <div class="col">
                                            <label for="empid" class="control-label"> مديونية سيارات</label>
                                            <input type="text" class="form-control" id="debtCarEmp" name="debtCarEmp"value="{{$item->debtCarEmp}}" onfocusout="calc()">   
                                        </div>
                                    </div>
                                    <div class="col">
                                        <label for="empid" class="control-label">مبلغ كفالة موظف آخر</label>
                                        <input type="text" class="form-control" id="anothSponosrEmp" name="anothSponosrEmp" onfocusout="calc()" value="{{$item->anothSponosrEmp}}">
                                    </div>
                                    <div class="col">
                                        <label for="empid" class="control-label">إجمالي الإلتزامات</label>
                                        <input type="text" class="form-control" id="totalCommitmentEmp" name="totalCommitmentEmp" readonly >
                                    </div>
                                    <div class="col">
                                        <label for="empid" class="control-label">الضمانات المتاحة</label>
                                        <input type="text" class="form-control" id="guaranteesAvailableEmp" name="guaranteesAvailableEmp"  readonly >
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="sprDeductionsBox" name="sprDeductionsBox" value="{{$sprDeductionsBox[0]['amt']}}" readonly>{{-- M1 --}}
                                            </div>
                                        </div>
                                        <br>
                                        <h5 class="text-center">الضمانات</h5>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="balancebox" class="control-label">رصيد اشتراك الصندوق</label>
                                                <input type="text" class="form-control" id="balanceboxSpr" name="balanceboxSpr" onfocusout="calc()" value="{{$item->balanceboxSpr}}">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <label for="empid" class="control-label">إجمالي الضمانات</label>
                                        ...
                                        <div class="col">
                                            <label for="empid" class="control-label">مبلغ كفالة موظف آخر</label>
                                            <input type="text" class="form-control" id="anothSponosrSpr" name="anothSponosrSpr" onfocusout="calc()" value="{{$item->anothSponosrSpr}}">
                                        </div>
                                        <div class="col">
                                            <label for="empid" class="control-label">إجمالي الإلتزامات</label>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <label for="empid" class="control-label">إجمالي الضمانات</label>
                                            <input type="text" class="form-control" id="totalGuaranteesAll" name="totalGuaranteesAll" readonly>
                                        </div>
                                        <div class="col">
                                            <label for="empid" class="control-label">إجمالي الإلتزامات</label>
                                            <input type="text" class="form-control" id="totalCommitmentAll" name="totalCommitmentAll" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label for="empid" class="control-label">الضمانات المتاحة</label>
                                            <input type="text" class="form-control" id="guaranteesAvailable" name="guaranteesAvailable" readonly>
                                        </div>
                                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label for="endService" class="control-label">رصيد نهاية الخدمة</label>
                                            <input type="text" class="form-control" id="endServiceEmp" name="endServiceEmp" value="{{$endServiceEmp2}}" readonly>
                                        </div>
                                        <div class="col">
                                            <label for="balancebox" class="control-label">رصيد اشتراك الصندوق</label>
                                            <input type="text" class="form-control" id="balanceboxEmp" name="balanceboxEmp" onfocusout="calc()" value="{{$item->balanceboxEmp}}">
                            ...
                            @else
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="hidden" name="sprId" class="form-control" value="{{ $sprId }}" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="salary" class="control-label">الراتب</label>
                                                <input type="text" class="form-control" id="salarySpr" name="salarySpr" value="{{ $sprSalary }}" readonly>
                                            </div>
                                            <div class="col">
                                                <label for="sprDeductionsBox" class="control-label">قسط الإشتراك</label>
                                                <input type="text" class="form-control" id="sprDeductionsBox" name="sprDeductionsBox" value="{{$sprDeductionsBox[0]['amt']}}" readonly> {{-- M2 --}}
                                            </div>
                                        </div>
                                        <br>
                                        <h5 class="text-center">الضمانات</h5>
                                        <div class="row">
                                            <div class="col">
                                                <label for="endService" class="control-label">رصيد نهاية الخدمة</label>
                                                <input type="text" class="form-control" id="endServiceSpr" name="endServiceSpr" value="{{$endServiceSpr}}" readonly>
                                            </div>
                                            <div class="col">
                                                <label for="balancebox" class="control-label">رصيد اشتراك الصندوق</label>
                                                <input type="text" class="form-control" id="balanceboxSpr" name="balanceboxSpr" onfocusout="calc()" value="{{-- {{$item->balanceboxSpr}} --}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="endServiceEmp" name="endServiceEmp" value="{{round($endServiceEmp2)}}" readonly>
                            </div>
                            <div class="col">
                                <label for="balancebox" class="control-label">رصيد اشتراك الصندوق</label>
                                <input type="text" class="form-control" id="balanceboxEmp" name="balanceboxEmp" onfocusout="calc()" value="0">
                            </div>
                        </div>
                        <div class="col">
                            <label for="empid" class="control-label">إجمالي الضمانات</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="empid" class="control-label">مديونية أجهزة واثاث</label>
                                <input type="text" class="form-control" id="debtFurnitureEmp" name="debtFurnitureEmp" value="0" onfocusout="calc()">
                            </div>
                            <div class="col">
                                <label for="empid" class="control-label"> مديونية سيارات</label>
                                <input type="text" class="form-control" id="debtCarEmp" name="debtCarEmp"value="0" onfocusout="calc()">   
                            </div>
                        </div>
                        <div class="col">
                            <label for="empid" class="control-label">مبلغ كفالة موظف آخر</label>
                            <input type="text" class="form-control" id="anothSponosrEmp" name="anothSponosrEmp" onfocusout="calc()" value="0">
                        </div>
                        <div class="col">
                            <label for="empid" class="control-label">إجمالي الإلتزامات</label>
                            <input type="text" class="form-control" id="totalCommitmentEmp" name="totalCommitmentEmp" readonly >
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="sprDeductionsBox" class="control-label">قسط الإشتراك</label>
                                    <input type="text" class="form-control" id="sprDeductionsBox" name="sprDeductionsBox" value="{{$sprDeductionsBox[0]['amt']}}" readonly> {{-- M3 --}}
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="endService" class="control-label">رصيد نهاية الخدمة</label>
                                    <input type="text" class="form-control" id="endServiceSpr" name="endServiceSpr" value="{{round($endServiceSpr)}}" readonly>
                                </div>
                                <div class="col">
                                    <label for="balancebox" class="control-label">رصيد اشتراك الصندوق</label>
                                    <input type="text" class="form-control" id="balanceboxSpr" name="balanceboxSpr" onfocusout="calc()" value="">
                                </div>
                            </div>
                            <div class="col">
                                <label for="empid" class="control-label">إجمالي الضمانات</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="empid" class="control-label">مديونية أجهزة واثاث</label>
                                    <input type="text" class="form-control" id="debtFurnitureSpr" name="debtFurnitureSpr" value="0" onfocusout="calc()">
                                </div>
                                <div class="col">
                                    <label for="empid" class="control-label"> مديونية سيارات</label>
                                    <input type="text" class="form-control" id="debtCarSpr" name="debtCarSpr"value="0" onfocusout="calc()">   
                                </div>
                            </div>
                            <div class="col">
                                <label for="empid" class="control-label">مبلغ كفالة موظف آخر</label>
                                <input type="text" class="form-control" id="anothSponosrSpr" name="anothSponosrSpr" onfocusout="calc()" value="0">
                            </div>
                            <div class="col">
                                <label for="empid" class="control-label">إجمالي الإلتزامات</label>
                                <input type="text" class="form-control" id="totalCommitmentSpr" name="totalCommitmentSpr" readonly >
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row" id="resonRefusal">
                            <div class="col-lg">
                                <label for="">السبب</label>
                                <textarea class="form-control" name="reson" rows="3"></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="d-flex justify-content-center">
