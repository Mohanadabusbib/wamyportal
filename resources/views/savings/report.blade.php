                            ...
                            <table id="example" class="table key-buttons text-md-nowrap" style="font-size: 16px">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">{{__('lable.salary')}}</th>
                                        <th class="border-bottom-0">{{__('lable.newpremium')}}</th>
                                        <th class="border-bottom-0">{{__('lable.contributelable')}}</th>
                                        <th class="border-bottom-0">{{__('lable.oldpremium')}}</th>
                                        <th class="border-bottom-0">{{__('lable.dateupdate')}}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            {{ number_format($item->total_sal, 2) }}
                                            {{-- {{ number_format($item->salary, 2) }} --}}
                                            </td>
                                        <td>{{ number_format($item->newpremium, 2) }}</td>
                                        <td>{{number_format($item->contribute, 2)}}</td>
                                        <td>
                                            @if ($item->previouspremium == 0)
                                                -    
                                            @else
                                                {{ number_format($item->previouspremium, 2) }}
                                            @endif
                                        </td>
                                        <td>
                                            @if ($item->previouspremium == 0)
